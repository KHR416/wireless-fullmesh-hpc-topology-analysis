...
\newcommand{\IEEEauthorblockN}[1]{\textbf{#1}\\[0.5ex]}
\newcommand{\IEEEauthorblockA}[1]{\begin{tabular}[t]{c}#1\end{tabular}}

\title{Analysis of Required Link Bandwidth for Wireless Full-Mesh Networks}
\author{\IEEEauthorblockN{Tae-In Oh}
\IEEEauthorblockA{\textit{School of Electrical Engineering} \\
\textit{Korea University}\\
Seoul, South Korea \\
logan10@korea.ac.kr}
\and
\IEEEauthorblockN{Young-Chai Ko}
\IEEEauthorblockA{\textit{School of Electrical Engineering} \\
\textit{Korea University}\\
Seoul, South Korea \\
koyc@korea.ac.kr}
\and
\IEEEauthorblockN{Woo-Nyeong Choe}
\IEEEauthorblockA{\textit{School of Electrical Engineering} \\
\textit{Korea University}\\
Seoul, South Korea \\
hyy741@korea.ac.kr}
...
\noindent\textbf{Keywords:} HPC network topology; wireless full-mesh; bisection bandwidth; maximum concurrent flow; TopoBench; Fat-tree; Jellyfish; Dragonfly; Torus; Hypercube
...
\begin{tabular}{@{}p{0.20\linewidth}p{0.16\linewidth}p{0.12\linewidth}p{0.12\linewidth}p{0.25\linewidth}@{}}
\toprule
